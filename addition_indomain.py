...
def main():
    X_train_100, y_train_100 = get_embeddings_add(train_100)
    X_test_100, y_test_100 = get_embeddings_add(test_100)

    X_train_100 = np.array([x for x in X_train_100])
    X_test_100 = np.array([x for x in X_test_100])
    ...
    X_train_1000, y_train_1000 = get_embeddings_add(train_1000)
    X_test_1000, y_test_1000 = get_embeddings_add(test_1000)

    X_train_1000 = np.array([x for x in X_train_1000])
    X_test_1000 = np.array([x for x in X_test_1000])
    ...
    X_train, y_train = get_embeddings_add(train)
    X_test, y_test = get_embeddings_add(test)
